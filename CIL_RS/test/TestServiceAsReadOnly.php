 ...
 * @covers Email
 */
final class TestServiceAsReadOnly extends TestCase
{
    ...
    public function testListSubjects()
    {
        ...
        //$url = TestServiceAsReadOnly::$elasticsearchHost . "/CIL_RS/index.php/rest/subjects";
        $url = TestServiceAsReadOnly::$elasticsearchHost .$this->context."/subjects";
    ...
    public function testAdvSearchOntology()
    {
        ...
        //echo $input;
        //$url = TestServiceAsReadOnly::$elasticsearchHost . "/CIL_RS/index.php/rest/advanced_document_search";
        $url = TestServiceAsReadOnly::$elasticsearchHost . $this->context."/advanced_document_search";
    ...
    public function testWebsite_homepage_settings()
    {
        ...
        //$url = TestServiceAsReadOnly::$elasticsearchHost . "/CIL_RS/index.php/rest/website_settings/homepage";
        $url = TestServiceAsReadOnly::$elasticsearchHost . $this->context."/website_settings/homepage";
    ...
    public function testSimple_ontology_search_by_name()
    {
        ...
        //$url = TestServiceAsReadOnly::$elasticsearchHost."/CIL_RS/index.php/rest/simple_ontology_search/biological_processes/Name/cell%20death";
        $url = TestServiceAsReadOnly::$elasticsearchHost. $this->context."/simple_ontology_search/biological_processes/Name/cell%20death";
    ...
    public function testSimple_ontology_search_by_synonym()
    {
        ...
        //$url = TestServiceAsReadOnly::$elasticsearchHost."/CIL_RS/index.php/rest/simple_ontology_search/biological_processes/Synonyms/necrosis";
        $url = TestServiceAsReadOnly::$elasticsearchHost.$this->context."/simple_ontology_search/biological_processes/Synonyms/necrosis";
    ...
    public function testSimple_ontology_search_by_wrong_name()
    {
        ...
        //$url = TestServiceAsReadOnly::$elasticsearchHost."/CIL_RS/index.php/rest/simple_ontology_search/biological_processes/Name/tesetsgsgrert";
        $url = TestServiceAsReadOnly::$elasticsearchHost.$this->context."/simple_ontology_search/biological_processes/Name/tesetsgsgrert";
    ...
    public function testSimple_ontology_search_by_wrong_synonym()
    {
        ...
        //$url = TestServiceAsReadOnly::$elasticsearchHost."/CIL_RS/index.php/rest/simple_ontology_search/biological_processes/Synonyms/tsetafrwer34";
        $url = TestServiceAsReadOnly::$elasticsearchHost.$this->context."/simple_ontology_search/biological_processes/Synonyms/tsetafrwer34";
    ...
    public function testSimple_ontology_expansion_by_name()
    {
        ...
        //$url = TestServiceAsReadOnly::$elasticsearchHost."/CIL_RS/index.php/rest/simple_ontology_expansion/biological_processes/Name/cell%20death";
        $url = TestServiceAsReadOnly::$elasticsearchHost.$this->context."/simple_ontology_expansion/biological_processes/Name/cell%20death";
    ...
    public function testSimple_ontology_expansion_by_synonym()
    {
        ...
        //$url = TestServiceAsReadOnly::$elasticsearchHost."/CIL_RS/index.php/rest/simple_ontology_expansion/biological_processes/Synonyms/necrosis";
        $url = TestServiceAsReadOnly::$elasticsearchHost.$this->context."/simple_ontology_expansion/biological_processes/Synonyms/necrosis";
    ...
    public function testSimple_ontology_expansion_by_wrong_name()
    {
        ...
        //$url = TestServiceAsReadOnly::$elasticsearchHost."/CIL_RS/index.php/rest/simple_ontology_expansion/biological_processes/Name/ataetawesdfgf";
        $url = TestServiceAsReadOnly::$elasticsearchHost.$this->context."/simple_ontology_expansion/biological_processes/Name/ataetawesdfgf";
    ...
    public function testSimple_ontology_expansion_by_wrong_synonym()
    {
        ...
        //$url = TestServiceAsReadOnly::$elasticsearchHost."/CIL_RS/index.php/rest/simple_ontology_expansion/biological_processes/Synonyms/teatesagdfgdfg";
        $url = TestServiceAsReadOnly::$elasticsearchHost.$this->context."/simple_ontology_expansion/biological_processes/Synonyms/teatesagdfgdfg";
    ...
    public function testAdvDataSearch()
    {
        ...
        //$url = TestServiceAsReadOnly::$elasticsearchHost . "/CIL_RS/index.php/rest/subjects?search=mouse";
        $url = TestServiceAsReadOnly::$elasticsearchHost . $this->context."/adv_data_search";
    ...
    public function testGroupInfo()
    {
        ...
        $url = TestServiceAsReadOnly::$elasticsearchHost . $this->context."/groups/36613";
        echo "\nGroupURL:".$url;
        $response = $this->curl_get($url);
        if(is_null($response))
        {
    ...
    public function testOntology_expansion_by_name()
    {
        ...
        //$url = TestServiceAsReadOnly::$elasticsearchHost."/CIL_RS/index.php/rest/simple_ontology_expansion/biological_processes/Name/cell%20death";
        $url = TestServiceAsReadOnly::$elasticsearchHost.$this->context."/ontology_expansion/biological_processes/Name";
        $array = array();
    ...
    public function testOntology_expansion_by_name_with_comma()
    {
        ...
        //$url = TestServiceAsReadOnly::$elasticsearchHost."/CIL_RS/index.php/rest/simple_ontology_expansion/biological_processes/Name/cell%20death";
        $url = TestServiceAsReadOnly::$elasticsearchHost.$this->context."/ontology_expansion/mouse_gross_anatomies/Name";
        $array = array();
    ...
    public function testOntology_expansion_by_synonym()
    {
        ...
        //$url = TestServiceAsReadOnly::$elasticsearchHost."/CIL_RS/index.php/rest/simple_ontology_expansion/biological_processes/Synonyms/necrosis";
        $url = TestServiceAsReadOnly::$elasticsearchHost.$this->context."/ontology_expansion/biological_processes/Synonyms";
        $array = array();
    ...
    public function testCategoryTotalSorting()
    {
        ...
        $url = TestServiceAsReadOnly::$elasticsearchHost.$this->context."/category/cell_process/Total/desc/0/10000";
        $response = $this->curl_get($url);
        //echo $response;
        $result = json_decode($response);
        if(isset($result->error))
